const maps = [
    ...
    "fy_buzzkill", "fy_buzzwood", "fy_comicbdust_cz", "fy_deck16_cz", "fy_dust17", "fy_kvayked", "fy_nemesis_world", "gg_playground_x_sn", "small_kingdom_sn",
    "aim_vermond_sn", "de_dust_pod_sn", "de_dust_kristal578", "gg_dustworld_cz", "gg_klobbmap_cz", "thi_tran_sinh_tu", "dm_origami_sn", "fy_dust_aim", "gg_pool_suite", "gg_rapidfire", "de_chateau_cz", "de_cod_stalingrad", "de_halla",
    "fy_pool_day3", "fy_snow2", "fy_snow_2016", "fy_snow_dew", "fy_snow_dino", "fy_snow_fg2", "fy_snowoot_cz", "fy_waterland_cz", 
    "gg_anubis", "gg_camper_cs16", "gg_cz", "sp_trash_metal", "gg_2minaretz", "gg_33_frisson", "gg_33_mario", "gg_$3000$_b5", "gg_aim_paranoia", "gg_arabia_mz", "gg_arena_future", 
    ...
    "gg_mansion_room", "gg_mariocastle_mt", "gg_mini_inferno", "gg_mini_dust2_rmk", "de_dust2_2020","de_runway","dm_industry_cso","dm_industry2","dm_port","fy_iceworld_xxl_sn","fy_sands","fy_snow_boom_blood_sn",
    "fy_snow_boom_sn", "fy_buzzkill2", "gg_fy_poolparty_sn", "sa_treetops_cz", "gg_abandoned_town","gg_dust_teleport_v1","gg_from_hell","gg_sand_cz","gg_kolf","gg_star","ka_deagle3_sn",
